...
const Home = () => {
  return (
    <Box className="box-border flex min-h-screen flex-col items-center justify-center p-6 md:flex-row">
      {/* 프로필 사진 */}
      <Box component="img" src={temp.src} alt="Profile" className="mb-6 h-80 min-w-80 rounded-full md:mb-0 md:mr-8" />
      {/* 텍스트 및 버튼 */}
